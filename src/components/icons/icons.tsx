...
export const CartIcon = ({...props}) => {
  return <CartImage {...props} />
}
export const SealingMachineIcon = ({...props}) => {
  return <SealingMachineImage {...props} />
}
export const ComponentIcon = ({...props}) => {
  return <ComponentImage {...props} />
}
export const EditIcon = ({...props}) => {
  return <EditImage {...props} />
}
export const TrashIcon = ({...props}) => {
  return <TrashImage {...props} />
}
export const ExcelIcon = ({...props}) => {
  return <ExcelImage {...props} />
}